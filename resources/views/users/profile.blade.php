                ...
                <div class="flex flex-col gap-1 w-full">
                    ...
                    <div class="flex gap-3 mt-auto">
                        @if($isMe)
                            ...
                            <a href="{{ route('user.cv', $user->id) }}" class="bg-slate-900 text-white px-8 py-2.5 rounded-full font-bold text-sm shadow-lg hover:bg-slate-800 transition-all flex items-center gap-2">

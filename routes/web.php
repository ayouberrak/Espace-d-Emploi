...
Route::post('/recruiter/jobs/{id}/toggle', [RecruiterController::class, 'toggleJobStatus'])->name('recruiter.jobs.toggle');
...
Route::get('/user/{id}/cv', [App\Http\Controllers\PdfController::class, 'generateCv'])->name('user.cv');
